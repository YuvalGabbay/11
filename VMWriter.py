...
class VMWriter:
    ...
    def __init__(self, output_stream: typing.TextIO) -> None:
        ...
        self.segments_dict = {"CONST":'constant', "ARG":"argument","LOCAL":"local", "STATIC":"static",
    ...
    def write_push(self, segment: str, index: int) -> None:
        ...
        """
        # Your code goes here!
        self.output_stream.write('push '+self.segments_dict[segment]+" "+str(index)+"\n")
    ...
    def write_pop(self, segment: str, index: int) -> None:
        ...
        """
        self.output_stream.write('pop '+self.segments_dict[segment]+" "+str(index)+"\n")
